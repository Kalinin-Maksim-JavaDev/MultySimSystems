 ...
 * @author kalinin
 */
public abstract class Load extends InteractvePanel {
     ...
     */
    public Load(boolean oneThread_, ISpaceManager canva) {
    ...
    public IDomainModel CreateModel() {
        return new SaveLoadDialog(getMod(),SaveLoadDialog.Load) {
